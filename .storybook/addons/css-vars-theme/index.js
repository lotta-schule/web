...
const Panel = () => {
    ...
    React.useEffect(() => {
        document.querySelector('#storybook-preview-iframe').contentWindow
            .postMessage('Lotta-Storybook-CSS-Theming-Addon:' + JSON.stringify(state));

        localStorage.setItem('lotta-theme', JSON.parse(state));
    }, [state]);
