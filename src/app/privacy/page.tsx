        ...
        <>
            <Box className={styles.box}>
                ...
                <p>
                    ...
                    insbesondere auf unseren Webseiten, in mobilen Applikationen
                    sowie innerhalb externer Onlinepräsenzen, wie z.B. unserer
            ...
            <Box className={styles.box}>
                ...
                <p>
                    ...
                    personenbezogenen Daten verarbeiten, mit. Bitte beachte,
                    dass zusätzlich zu den Regelungen der DSGVO die nationalen
                    Datenschutzvorgaben in deinem bzw. unserem Wohn- und
            ...
            <Box className={styles.box}>
                ...
                <p>
                    ...
                    Inanspruchnahme von Diensten Dritter oder der Offenlegung
                    bzw. Übermittlung von Daten an andere Personen, Stellen oder
                    Unternehmen stattfindet, erfolgt dies nur im Einklang mit
                ...
                <p>
                    ...
                    lassen wir die Daten nur in Drittländern mit einem
                    anerkannten Datenschutzniveau, zu denen die unter dem
                    "Privacy-Shield" zertifizierten US-Verarbeiter gehören, oder
                    ...
                    verbindlicher interner Datenschutzvorschriften, verarbeiten
                ...
                <p>
                    Alle von Nutzern hochgeladenen Bilder werden zum Schnelleren
                    Abruf zum Unternehmen
                    <a
                ...
                <p>
                    Alle von Nutzern hochgeladenen Video und Audiodateien werden
                    zum Unternehmen
                    <a
                    ...
                    zur Umwandlung hochgeladen. Sie werden aber bei Digitalocean
            ...
            <Box className={styles.box}>
                ...
                <p>
                    ...
                    können unterschiedliche Angaben gespeichert werden. Zu den
                    Angaben können z.B. der Loginstatus, oder die Stelle, an der
                ...
                <p>
                    ...
                    Betrachten bestimmter Inhalte, Nutzen von Funktionen etc.)
                    auf einzelnen Webseiten in einem Nutzerprofil gespeichert
                    werden. Solche Profile dienen dazu, den Nutzern z.B. Inhalte
                    anzuzeigen, die ihren potentiellen Interessen entsprechen.
                    Dieses Verfahren wird auch als "Tracking", d.h.,
                    Nachverfolgung der potentiellen Interessen der Nutzer
                    bezeichnet. Zu dem Begriff der Cookies zählen wir ferner
                ...
                <p>
                    ...
                    widerrufen oder der Verarbeitung Deiner Daten durch
                    Cookie-Technologien zu widersprechen (zusammenfassend als
                    "Opt-Out" bezeichnet).
                    <br />
                    Du kannst deinen Widerspruch zunächst mittels der
                    Einstellungen deines Browsers erklären, z.B., indem Sie die
                    Nutzung von Cookies deaktivierst (wobei hierdurch auch die
                    Funktionsfähigkeit deines Onlineangebotes eingeschränkt
                    werden kann).
                    <br />
                    Für andere Möglichkeiten, schreib uns doch einfach eine
                    Email und wir können mit dir weitere Lösungen besprechen.
                </p>
            </Box>
            ...
            <Box className={styles.box}>
                ...
                <p>
                    ...
                    gehören insbesondere die Login-Informationen (Name, Passwort
                ...
                <p>
                    ...
                    informiert werden. Wenn Nutzer ihr Nutzerkonto gekündigt
                    ...
                    berechtigt, sämtliche während der Vertragsdauer gespeicherte
                ...
                <p>
                    ...
                    hierzu besteht eine gesetzliche Verpflichtung.
                </p>
                <div>
                    <ul>
                        <li>
                        ...
                        <li>
                            ...
                            Sicherheitsmaßnahmen, Verwaltung und Beantwortung
                            von Anfragen.
                        </li>
                        <li>
            ...
            <Box className={styles.box}>
                ...
                <div>
                    <ul>
                        ...
                        <li>
                            <strong>Zwecke der Verarbeitung:</strong> Content
                ...
                <p>
                    <ul>
                        <li>
                            ...
                            DigitalOcean, LLC, 101 Avenue of the Americas, New
                            York, New York 10013, USA; Website:
            ...
            <Box className={styles.box}>
                ...
                <p>
                    ...
                    Wir informieren dich, sobald durch die Änderungen eine
                    Mitwirkungshandlung deinerseits (z.B. Einwilligung) oder
            ...
            <Box className={styles.box}>
                ...
                <ul>
                    <li>
                        ...
                        dessen Hilfe Inhalte eines Onlineangebotes, insbesondere
                        große Mediendateien, wie Grafiken oder Programm-Skripte
                        mit Hilfe regional verteilter und über das Internet
                        verbundener Server, schneller und sicherer ausgeliefert
                        werden können.
                    </li>
                    <li>
